...
<html lang="zh-CN">
        <head>
             <base href="<%=basePath%>">
                ...
                <script src="js/home.plain.js"></script>
                <script src="js/pub/zeroclipboard/ZeroClipboard.js"></script>
                <script src="js/invite.plain.js"></script>
                        ...
                        <div id="Div_dashboard" class="">
                                <div class="unit">
                                        <div class="privateModel radiu">
                                                <div class="title">
                                                        <span class="tit"><img src="images/index/gailan/personal_note_16.png" alt="myNote" />我的笔记</span>
                                                </div>
                                                <div class="conBox">
                                                        <a style="float:left;" target="_blank" href="/lightnote/user/editnote?noteid=1">
                                                                <div class="btn BT_big">
                                                                <span class="imgBox"><img src="images/index/gailan/newnote.png" alt="newNote" ></span>
                                                                <p class="txt">快速记事</p>
                                                                <p class="introduce">捕捉思想火花和您的每日心情</p>
                                                                </div>
                                                        </a>
                                                        <a href="/lightnote/user/mynote">
                                                                <div class="btn BT_big">
                                                                        <span class="imgBox"><img src="images/index/gailan/allnote.png" alt="allNote" ></span>
                                                                        <p class="txt">浏览笔记</p>
                                        ...
                                        <div class="publicModel radiu">
                                                <div class="title">
                                                        <span class="tit"><img src="images/index/gailan/group_1.png" alt="group"/>群组合作</span>
                                                </div>
                                                <div class="conBox">
                                                        <a href="/lightnote/user/group">
                                                        <div class="btn BT_big">
                                                                <span class="imgBox"><img src="images/index/gailan/group_1.png" alt="group" /></span>
                                                                <p class="txt">管理群组</p>
                                ...
                                <div class="sideBar">
                                        <div class="userInfo">
                                                ...
                                                <p><img class="userIcon" src="images/index/gailan/user_icon_16.png" alt="user"/><span class="userName textOver">362294931@qq.com</span><a style="margin-left:10px;" href="/profile" title="用户设置">用户设置</a>
                                                ...
                                                <p style="margin-top:15px;"><span class="emailIcon"><img alt="email" src="images/index/gailan/email_icon_16.png" /></span>
                                                        <span>邮箱验证</span>
                                                            <span class="yz">未验证</span><span><a href="/profile#email">去验证</a></span>
                                                </p>
                                                <p><img alt="password" class="icon" src="images/index/gailan/password_setting_icon_16.png" /><span>密码复杂度</span><span class="mm">一般</span><span><a href="/profile#pass">修改密码</a></span></p>
                                        </div>  
                                                ...
                                                <ul>
                                                        <li>
                                                                <a class="d1" target="_blank" href="http://update.thinkernote.com/windows/config/ThinkerNote-Setup.apk">
                                                                        ...
                                                                        <!--img title="Android客户端下载" alt="Android客户端下载" src="images/index/gailan/download_android.png"/-->
                                                                        <span>Android</span>
                                                                </a>
                                                        </li>
                                                        <li>
                                                                <a class="d2" target="_blank" href="http://itunes.apple.com/us/app/id432043927">
                                                                        ...
                                                                        <!--img alt="iPhone客户端下载" title="iPhone客户端下载" src="images/index/gailan/download_apple.png"/-->
                                                                        <span>iPhone</span>
                                                                </a>
                                                        </li>
                                                        <li>
                                                                <a class="d3" target="_blank" href="http://update.thinkernote.com/windows/config/ThinkerNote-Setup.exe">
                                                                        ...
                                                                        <!--img title="Windows客户端下载" src="images/index/gailan/download_pc.png"/-->
                                                                        <span>Windows</span>
                                                                </a>
                                                        </li>
                                                </ul>
